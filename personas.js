...
exports.personaTestingCriteria = exports.allPersonas = exports.accessibilityPersonas = exports.standardPersonas = void 0;
exports.getPersonaById = getPersonaById;
exports.getPersonasByCategory = getPersonasByCategory;
exports.getHighPriorityPersonas = getHighPriorityPersonas;
exports.standardPersonas = [
    {
        id: 'tech-savvy',
...
exports.allPersonas = [...exports.standardPersonas, ...exports.accessibilityPersonas];
exports.personaTestingCriteria = {
    'tech-savvy': {
        usabilityWeight: 0.3,
...
function getPersonaById(id) {
    return exports.allPersonas.find(persona => persona.id === id);
}
function getPersonasByCategory(category) {
    return exports.allPersonas.filter(persona => persona.category === category);
}
function getHighPriorityPersonas() {
    return exports.allPersonas.filter(persona => persona.priority === 'high');
}
